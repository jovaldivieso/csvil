...
The state and action abstractions live in
[systems/state_space_types.py](systems/state_space_types.py) and use explicit
Euclidean and SE(2) names to mirror the underlying geometry.
