...
This repository contains a modular pipeline for controller synthesis via imitation learning. The primary goal is to imitate a computationally heavy optimal motion planner using a faster neural policy accelerate inference.
