...
def main():
    ...
    env = DynamicsGymWrapper(simulator, max_steps=200)
    ...
    for i in range(num_trajectories):
        ...
        # Show start position and heading
        plt.scatter(trajectory_x[0], trajectory_y[0], color="black", s=20, zorder=4)
    ...
    plt.title("Gymnasium Wrapper Test (Unicycle1 + CasADi)")
    ...
    output_path = os.path.join(os.path.dirname(__file__),
                               "gym_unicycle1_casadi_paths.pdf")
